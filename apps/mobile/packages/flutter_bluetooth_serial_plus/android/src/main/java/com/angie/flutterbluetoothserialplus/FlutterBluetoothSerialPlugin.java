...
//        if (true) throw new RuntimeException("FlutterBluetoothSerial Attached to activity");
    ...
    @SuppressWarnings("deprecation")
    private void startActivityForResultCompat(Intent intent, int requestCode) {
        ActivityCompat.startActivityForResult(activity, intent, requestCode, null);
    }

    @SuppressWarnings("deprecation")
    private boolean disableBluetoothCompat() {
  ...
  private void ensurePermissions(EnsurePermissionsCallback callbacks) {
            ...
            switch (call.method) {
                ...
                case "requestEnable":
                    if (!bluetoothAdapter.isEnabled()) {
                        ...
                        startActivityForResultCompat(intent, REQUEST_ENABLE_BLUETOOTH);
                    } else {
                        result.success(true);
                    }
                    break;
                ...
                case "requestDisable":
                    if (bluetoothAdapter.isEnabled()) {
                        result.success(disableBluetoothCompat());
                    } else {
                        result.success(false);
                    }
                    break;
    ...
    break;
                ...
                case "requestDiscoverable": {
                    ...
                    pendingResultForActivityResult = result;
                    startActivityForResultCompat(intent, REQUEST_DISCOVERABLE_BLUETOOTH);
                    break;
                }
