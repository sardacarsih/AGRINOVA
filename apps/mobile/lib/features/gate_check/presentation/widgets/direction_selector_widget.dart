...
class DirectionSelectorWidget extends StatelessWidget {
  ...
  Widget _buildDirectionButton(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: isStacked
            ? _buildStackedLayout(direction, color, isSelected)
            : _buildRowLayout(direction, color, isSelected),
      ),
    );
  }
  ...
  Widget _buildRowLayout(
    ...
    return RadioGroup<GateCheckDirection>(
