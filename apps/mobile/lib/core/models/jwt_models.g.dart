...
AssignmentScope _$AssignmentScopeFromJson(
  ...
  companies:
      ...
      const [],
  estates:
      (json['estates'] as List<dynamic>?)?.map((e) => e as String).toList() ??
      const [],
  divisions:
...
User _$UserFromJson(Map<String, dynamic> json) => User(
  ...
  availableActions:
      ...
      const [],
  companyAccess:
      (json['companyAccess'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  assignedEstates:
      (json['assignedEstates'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  assignedDivisions:
      (json['assignedDivisions'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  assignedCompanies:
      (json['assignedCompanies'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
...
Map<String, dynamic> _$UserToJson(User instance) => <String, dynamic>{
  ...
  'role': instance.role,
  'effectiveMandorType': instance.effectiveMandorType,
...
AuthPayload _$AuthPayloadFromJson(Map<String, dynamic> json) => AuthPayload(
  ...
  assignments: json['assignments'] == null
      ? null
      : UserAssignments.fromJson(json['assignments'] as Map<String, dynamic>),
);
