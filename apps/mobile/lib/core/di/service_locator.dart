...
// - final storage = ServiceLocatorExtensions.storage;
...
extension ServiceLocatorExtensions on ServiceLocator {
  ...
  static UnifiedSecureStorageService get storage =>
      UnifiedSecureStorageService.instance;
  static GraphQLClientService get graphql =>
      ServiceLocator.get<GraphQLClientService>();
  static ConnectivityService get connectivity =>
      ServiceLocator.get<ConnectivityService>();
  static BiometricAuthService get biometrics =>
      ServiceLocator.get<BiometricAuthService>();
  ...
  static GraphQLAuthService get graphqlAuth =>
      ServiceLocator.get<GraphQLAuthService>();
